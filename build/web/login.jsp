        ...
        <form name="login" action="Login" method="post">
            ...
            <div class="jumbotron" style="margin-left:300px;width: 50% ;margin-top: 100px;height: 400px  ">
                <div class="div1"> 
                    ...
                    <center>
                        <br><br><br>
                        <h1 Style="color: #ffffff;text-shadow:  2px 3px 6px black;font-family: serif"> User Login </h1></center>
                    <br><br>
                 ...
                 <div class="div2"><br>
                     ...
                     <input type="submit" name="btn1" value="GetDetails" class="btn btn-primary">
